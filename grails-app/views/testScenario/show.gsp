...
<html>
    ...
    <body>
        ...
        <div id="show-testScenario" class="content scaffold-show" role="main">
            ...
            <f:display bean="testScenario" />
            <g:form resource="${this.testScenario}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.testScenario}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
